...
const aboutText = "I specialize in UI/UX design, web and mobile interfaces, and brand identity. I transform complex ideas into intuitive, visually striking designs using tools like Figma, Sketch, and Framer. Driven by research, clarity, and attention to detail, I create interfaces that don’t just look good-they work seamlessly.";
...
export default function About() {
  ...
  return (
    <section className="px-6 lg:px-8 py-8 bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.8fr] gap-20 items-start">
              ...
              >
                ...
                <div className="space-y-2 pl-2">
                  <p className="text-primary text-base font-mono">Ethical & integrity-driven</p>
                  <p className="text-primary text-base font-mono">Strategic problem-solving</p>
                  <p className="text-primary text-base font-mono">Critical thinking</p>
                </div>
              ...
              <div className="relative">
                <div className="text-[2.2rem] lg:text-[2.75rem] font-serif font-medium leading-tight text-primary">
                  {words.map((word, index) => {
                    ...
                    const wordStart = Math.max(0, (index - wordsPerGroup) / words.length);
      ...
      <div className="h-24 -mx-6 lg:-mx-8 relative overflow-hidden">
        <StripePattern 
          color="#0046FF"
          opacity={0.3}
          gap={6}
