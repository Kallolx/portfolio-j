...
export default function CaseStudyCard({
  ...
  const borderColor =
    index === 1 ? "border-[#FF8C42]/30" : "border-[#0046FF]/30";

  return (
    <div
      ref={container}
      className="sticky top-30 flex items-center justify-center min-h-[500px] lg:min-h-[600px] py-6 lg:py-12"
      style={{
    ...
    >
      <motion.div
        ...
        className={`relative w-full overflow-hidden rounded-2xl ${bgColor} ${borderColor} origin-top group`}
      >
        <Link
          href={`/case-study/${project.id}`}
          className="block relative h-full w-full cursor-pointer"
        >
          <div className="relative flex flex-col-reverse lg:flex-row h-full">
            {/* Left - Text content */}
            <div className="relative flex flex-col justify-between w-full lg:w-2/3 p-3 md:p-6 lg:p-10 z-10">
              {/* Tags */}
            ...
            <div className="relative w-full lg:w-1/3 h-[16rem] lg:h-96 flex items-center justify-center p-3 lg:p-6 pb-0 lg:pb-6">
