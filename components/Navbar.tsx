    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/">
            <motion.div
              className="font-serif font-medium text-2xl text-primary"
            >
              James Parker
            </motion.div>
          </Link>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="hidden lg:flex items-center gap-3 px-2 py-1 font-mono text-md text-text-primary"
          >
            <svg
            ...
            <span className="font-mono text-primary">hello@james.com</span>
          </motion.a>
