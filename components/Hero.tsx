    ...
    <section className="min-h-screen flex items-center justify-center px-6 lg:px-8 pt-28 pb-8 lg:pt-4 lg:pb-0">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-0 relative">
          ...
          <Link
            href="/about"
            className="col-span-2 md:col-span-2 h-auto md:h-100 border border-[#acc4ff]/30 rounded-2xl bg-[var(--background)] relative z-10 flex items-center justify-center p-3 order-1 md:order-2 group cursor-pointer"
            onMouseEnter={() => {
              const next = !videoToggle;
              setVideoToggle(next);
              if (videoRef.current) {
                videoRef.current.src = next ? "/img/reel.mp4" : "/img/reel-2.mp4";
          ...
          >
            <div className="bg-[var(--primary)] rounded-xl p-6 w-full h-full flex flex-col items-center justify-start gap-6 pt-8 transition-colors duration-500 ease-in-out relative overflow-hidden">
              ...
              <>
                <video
                  ...
                  muted
                  playsInline
                  className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out rounded-xl"
                />

                {/* Theme color overlay */}
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out rounded-xl mix-blend-multiply pointer-events-none"
              ...
              <motion.h2
                ...
                className="text-4xl md:text-6xl tracking-tight font-serif text-white mt-2 md:mt-4 text-center relative z-10"
              >
                Jamil Ifat
              </motion.h2>
            </div>
